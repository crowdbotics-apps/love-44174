"""
Django settings for love_44174 project.
...
WSGI_APPLICATION = 'love_44174.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "love_44174 API",
    "DESCRIPTION": "API documentation for love_44174 App",
    "VERSION": "v1",
}
